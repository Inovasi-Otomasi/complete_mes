...
class Order_model extends CI_Model
{
    ...
    var $column_order = array('id', 'line_rules', 'sku_code', 'quantity',  'created_at', 'started_at', 'finished_at', 'storage', 'status', 'progress', null); //set column field database for datatable orderable
    var $column_search = array('id', 'line_rules', 'sku_code', 'quantity',  'created_at', 'started_at', 'finished_at', 'storage', 'status', 'progress'); //set column field database for datatable searchable 
