...
class Order_model extends CI_Model
{
	...
	var $column_order = array('id', 'batch_id', 'lot_number', 'line_rules', 'sku_code', 'quantity',  'created_at', 'started_at', 'finished_at', 'storage', 'status', 'progress', 'pic_name', 'remark', 'detail', 'pic_name_2', 'remark_2', 'detail_2', 'location', null); //set column field database for datatable orderable
	var $column_search = array('id', 'batch_id', 'lot_number', 'line_rules', 'sku_code', 'quantity',  'created_at', 'started_at', 'finished_at', 'storage', 'status', 'progress', 'pic_name', 'remark', 'detail', 'pic_name_2', 'remark_2', 'detail_2', 'location'); //set column field database for datatable searchable 
