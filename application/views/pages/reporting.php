			...
			<div class="card-body m-2 table-responsive">
				...
				<div class="row my-5">
					<div class="row col">
						...
						<div class="col-12">
							<div class="GaugeMeter start-50 top-50 translate-middle" data-percent="<?php echo (int)(($summary['avg(performance_24h)'] ?: 0 + $summary['avg(availability_24h)'] ?: 0 + $summary['avg(quality_24h)'] ?: 0) / 3); ?>" data-text="<?php echo round(($summary['avg(performance_24h)'] ?: 0 + $summary['avg(availability_24h)'] ?: 0 + $summary['avg(quality_24h)'] ?: 0) / 3, 1); ?>" data-animationstep="0" data-size="150" data-append="%" data-width="15" data-text_size="0.18"></div>
						</div>
					</div>
					<div class="row col">
						<div class="col-12 mb-0">
