								...
								<div class="border-0 p-4 mb-2 bg-gray-400 border-radius-lg">
									...
									<div class="row">
										...
										<div class="col-lg-5">
											...
											<hr class="my-1 py-0">
											<div class="row">
												<p class="col-5 text-xl my-0 py-0">Small Stop Actual</p>
												<p class="col-2 text-xl my-0 py-0">:</p>
												<p class="col-5 text-xl my-0 py-0"><span class="text-dark font-weight-bold ms-sm-2" id='small_stop_temp_<?php echo $line['id']; ?>'></span> detik</p>
											</div>
											<hr class="my-1 py-0">
											<div class="row">
